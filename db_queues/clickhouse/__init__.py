...
WITH joined AS (
    SELECT
        ...
        c.cached_input_tokens        AS cached_input_tokens,
...
SELECT
    ...
    sum(total_cost) / uniqExact(root_trace_id)       AS avg_cost_per_run,
    sum(input_tokens + cached_input_tokens + output_tokens) AS total_tokens,
