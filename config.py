...
KAFKA_SSL_CA_FILE=os.getenv("KAFKA_SSL_CA_FILE","ca.pem")
KAFKA_SSL_CERT_FILE=os.getenv("KAFKA_SSL_CERT_FILE","service.cert")
KAFKA_SSL_KEY_FILE=os.getenv("KAFKA_SSL_KEY_FILE","service.key")
